...
<div class="card-wrapper">
    ...
    <h3 class="fw-bold mb-4">🛎️ {{ __('Add New Service') }}</h3>

    <form action="{{ route('admin.dich-vus.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-md-8">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('tendichvu') is-invalid @enderror" 
                           id="tendichvu" name="tendichvu" value="{{ old('tendichvu') }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('motadichvu') is-invalid @enderror" 
                              id="motadichvu" name="motadichvu" rows="6">{{ old('motadichvu') }}</textarea>
            ...
            <div class="col-md-4">
                ...
                <div class="mb-3 border p-3 rounded bg-light">
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="checkbox" value="1" id="la_gia_dao_dong" name="la_gia_dao_dong" {{ old('la_gia_dao_dong') ? 'checked' : '' }}>
                    ...
                    <div class="row">
                        <div class="col-12 mb-2">
                            ...
                            <input type="number" class="form-control @error('dongia') is-invalid @enderror" 
                                   id="dongia" name="dongia" value="{{ old('dongia') }}">
                        ...
                        <div class="col-12" id="box_dongia_toida" style="display: none;">
                            ...
                            <input type="number" class="form-control @error('dongia_toida') is-invalid @enderror" 
                                   id="dongia_toida" name="dongia_toida" value="{{ old('dongia_toida') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('donvitinh') is-invalid @enderror" 
                           id="donvitinh" name="donvitinh" value="{{ old('donvitinh') }}">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control bg-white text-muted" readonly id="file-name-display-service" 
                    ...
                    <input class="d-none @error('hinhanh') is-invalid @enderror" type="file" id="hinhanh" name="hinhanh"
                           onchange="document.getElementById('file-name-display-service').value = this.files[0] ? this.files[0].name : ''">
        ...
        <div class="mt-4 d-flex gap-2 border-top pt-3">
            <button type="submit" class="btn btn-primary btn-submit">
                <i class="material-symbols-outlined align-middle" style="font-size: 18px;">save</i> {{ __('Create') }}
            </button>
            <a href="{{ route('admin.dich-vus.index') }}" class="btn btn-secondary btn-cancel">
                <i class="material-symbols-outlined align-middle" style="font-size: 18px;">arrow_back</i> {{ __('Cancel') }}
            </a>
        </div>
    </form>
</div>
